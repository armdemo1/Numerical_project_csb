...
import './screen.css';
import { BookFilled,PieChartOutlined,CodeOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#4811C4",color:"#e89a3c" ,height: "100px" }}>
            <div className="headertext">
              <label><CodeOutlined  style={{color:"#00F9E5" ,fontSize:"40px", marginRight:"10px"}} />Numerical Method</label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#00F9E5", overflowY: "scroll" }}
                theme="light"
              >
            ...
            <Layout style={{backgroundColor:"white", padding: '0 25px 25px' }}>
          ...
          <Footer style={{ backgroundColor: "#4811C4", minHeight: 120 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "white" }}>
              Jetsada Puthong 6204062660021<br />

              <p style={{fontSize:"22px", verticalAlign:"text-bottom"}}><BookFilled style={{ fontSize: "30px" }} /><a style={{ color: "white", textDecoration: "none" }}> Department of Computer and Information Science</a></p>
